...
// Updated to the user-provided phone number
...
export const TRANSLATIONS: Record<'en' | 'bn', TranslationStrings> = {
  en: {
    ...
    loginPrompt: "Please enter your name and email to access your account dashboard",
    loginViaWA: "Access Profile",
    ...
    themeLabel: "Theme",
    benefits: {
      speed: { title: "Super Speed", desc: "Symmetrical speeds for all your needs" },
      price: { title: "Affordable", desc: "Best value packs in the country" },
      flex: { title: "Flexible", desc: "Choose packs that fit your lifestyle" }
    }
  },
  bn: {
    logo: "গতি",
    ...
    loginPrompt: "আপনার একাউন্ট ড্যাশবোর্ডে প্রবেশ করতে অনুগ্রহ করে আপনার নাম ও ইমেইল লিখুন",
    loginViaWA: "প্রোফাইল দেখুন",
    ...
    benefits: {
      ...
      flex: { title: "সহজলভ্য", desc: "আপনার জীবনযাত্রার সাথে মানানসই প্যাক বেছে নিন" }
    }
  }
};
